...
// SignIn Reducer
export const userReducerSignIn = (state = { userInfo: null, isAuthenticated: false }, action) => {
    switch (action.type) {
        ...
        case USER_SIGNIN_SUCCESS:
            return {
                loading: false,
                userInfo: action.payload,  // Assurez-vous que l'objet 'payload' contient un email
                isAuthenticated: true
            };
        case USER_SIGNIN_FAIL:
            return { loading: false, userInfo: null, isAuthenticated: false, error: action.payload };
        case USER_SIGNIN_RESET:
            return { userInfo: null, isAuthenticated: false };  // Réinitialisation propre
        default:
            return state;
    }
};
...
export const loadUserSingleReducer = (state = { user: {} }, action) => {
    switch (action.type) {
        ...
        case USER_LOAD_SINGLE_SUCCESS:
            return { loading: false, user: action.payload.user }; // Vérifiez que l'API renvoie bien `user`
