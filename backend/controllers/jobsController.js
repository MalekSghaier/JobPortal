...
// Route pour obtenir la liste des jobs
// Définir la route pour obtenir tous les jobs
exports.getJobs = async (req, res) => {
    try {
        // Attendez la réponse de Job.find() pour récupérer tous les jobs
        const jobs = await Job.find();
        // Réponse réussie avec les jobs récupérés
        res.json(jobs);
    } catch (err) {
